...
class DrawingViewPage(QtGui.QWidget):
    ...
    def __init__(self):
        ...
        self.widget_left_down.setStyleSheet("background-color:lightgray;")   
...
class DrawingAnalysePage(QtGui.QMainWindow):
    ...
    def set_toolbar(self):
        ...
        zoom_in.setIcon(QtGui.QIcon('/home/sabrinabct/Projets/DigiSun_2018/icons/zoom-in.svg'))
        zoom_out = QtGui.QAction('zoom_out',  toolbar)
        zoom_out.setIcon(QtGui.QIcon('/home/sabrinabct/Projets/DigiSun_2018/icons/search.svg'))
        large_grid = QtGui.QAction('large_grid',  toolbar)
        large_grid.setIcon(QtGui.QIcon('/home/sabrinabct/Projets/DigiSun_2018/icons/internet.svg'))
        small_grid = QtGui.QAction('small_grid',  toolbar)
        small_grid.setIcon(QtGui.QIcon('/home/sabrinabct/Projets/DigiSun_2018/icons/internet.svg'))
        helper_grid = QtGui.QAction('helper_grid',  toolbar)
        helper_grid.setIcon(QtGui.QIcon('/home/sabrinabct/Projets/DigiSun_2018/icons/internet.svg'))
        sunspot_view = QtGui.QAction('sunspot_view',  toolbar)
        sunspot_view.setIcon(QtGui.QIcon('/home/sabrinabct/Projets/DigiSun_2018/icons/share_1.svg'))
        dipole_view = QtGui.QAction('dipole_view',  toolbar)
        dipole_view.setIcon(QtGui.QIcon('/home/sabrinabct/Projets/DigiSun_2018/icons/share.svg'))
    ...
    def set_group_widget(self):
        ...
        for i in range(group_count):
            ...
            myQCustomQWidget.set_title("Group " + str(self.drawing_lst[self.current_count].group_lst[i].number),
                                       self.grid_position)
            myQCustomQWidget.set_spot_count(self.drawing_lst[self.current_count].group_lst[i].spots,
                                            self.grid_position)
            myQCustomQWidget.set_zurich_type(self.drawing_lst[self.current_count].group_lst[i].zurich,
                                             self.grid_position)
            myQCustomQWidget.set_mcIntosh_type(self.drawing_lst[self.current_count].group_lst[i].McIntosh,
                                                self.drawing_lst[self.current_count].group_lst[i].zurich,
                                                self.grid_position)
            myQCustomQWidget.set_latitude(self.drawing_lst[self.current_count].group_lst[i].latitude,
                                          self.grid_position)
            myQCustomQWidget.set_longitude(self.drawing_lst[self.current_count].group_lst[i].longitude,
                                           self.grid_position)
            myQCustomQWidget.set_surface(self.drawing_lst[self.current_count].group_lst[i].surface,
                                         self.grid_position)
            if self.drawing_lst[self.current_count].group_lst[i].zurich.upper()  in ["B","C","D","E","F","G"]:
                myQCustomQWidget.set_larger_spot(self.drawing_lst[self.current_count].group_lst[i].g_spot,
                                                 self.grid_position)      
